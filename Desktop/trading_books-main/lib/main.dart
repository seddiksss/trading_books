...
import 'package:trading_books/Views/screens/before_signin.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      initialRoute: AppRoutes.beforesignin,
      getPages: [
        GetPage(name: AppRoutes.onboarding, page: () => const Onboarding1()),
        GetPage(name: AppRoutes.beforesignin, page: () => const BeforeSignin()),
